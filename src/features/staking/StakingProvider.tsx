...
export const StakingProvider: React.FC<{
  children: ReactNode, connector: TonConnect, tonstakers: Tonstakers
  ...
  useTonstakersSetup(connector, tonstakers, setWallet, setLoader, setBalance, setInfo, wallet)

  return (
    <WalletContext.Provider value={{ wallet, loader, balance, info, setWallet }}>
      {children}
